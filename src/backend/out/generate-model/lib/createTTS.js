 ...
 */
export default async function createTTS(ssml, filename, voice) {
    /**
    ...
    await writeFile(path.join(__dirname, '../../../files/generate-model/temporary', `${filename}.mp3`), response.audioContent, 'binary');
}
